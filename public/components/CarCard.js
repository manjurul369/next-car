...
export default function CarCard({ carID, carName, type, carImg, oil, cap, price }) {
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-5 lg:p-8 flex flex-col max-w-[400px] min-w-[300px] cursor-pointer hover:shadow-xl transition-shadow duration-300 ease-in-out'>
